...
- **8-кроковий опитувальник (Wizard)**: динамічне формування переліку з 13+ типів документів (за замовчуванням військовозобов'язаний = "Так", трудова книжка, освіта/студент денної форми, діти, інвалідність, ВПО, ЧАЕС тощо).
